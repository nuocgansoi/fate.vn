...
class HtmlHelper
{
    ...
    public function rating_stars($score, $fullStar = 'fa fa-star', $halfStar = 'fa fa-star-half-o', $emptyStar = 'fa fa-star-o')
    {
        if (is_null($score)) {
            $score = 0;
        }
    ...
    public function mobile($classMobile = null, $classDesktop = null)
    {
        return agent()->isDesktop() ? $classDesktop : $classMobile;
    }

    public function get_gender_symbol($gender = null)
    {
